  ...
  app.controller('mainController', function($scope, $http){
    ...
    $scope.pageSize = 10;
       ...
       $scope.view_bill = function () {
        ...
        if (fav_bill !== null) {
          if (fav_bill.length === 0) {
            ...
            for(var i=0; i<$new.active_bills.length; i++) {
      ...
      $scope.toggle_bill = function (index, bill_fav) {
        ...
        bill_fav.fav = true;
        var fav_bill = [];
        fav_bill = JSON.parse(localStorage.getItem('bill_storage')); debugger;
        if (fav_bill !== null) {
          for(var k=0; k<fav_bill.length; k++) {
      ...
      $scope.toggle_comm = function (index, comm_house) { 
        ...
        var fav_committee = [];
        fav_committee = JSON.parse(localStorage.getItem('committee_storage')); debugger;
        for(var k=0; k<fav_committee.length; k++) {
