<?php
	...
	$start_url_leg_house = "http://congress.api.sunlightfoundation.com/legislators?chamber=house&apikey=dc64b50ea0094b8794a3a8d96db12f86&per_page=all";
		$json_string_leg_house = file_get_contents($start_url_leg_house);

	$start_url_leg_senate = "http://congress.api.sunlightfoundation.com/legislators?chamber=senate&apikey=dc64b50ea0094b8794a3a8d96db12f86&per_page=all";
		$json_string_leg_senate = file_get_contents($start_url_leg_senate);
	...
	$json_string = array($json_string_leg, $json_string_leg_house, $json_string_leg_senate, $json_string_bill, $json_string_committee_h, $json_string_committee_s, $json_string_committee_j);
	echo json_encode($json_string);
